...
- `get_monitors()` now queries `monitors all`, so disabled monitors are included in the result. https://github.com/BlueManCZ/hyprland-socket/pull/2
...
[0.12.2]: https://github.com/BlueManCZ/hyprland-socket/releases/tag/v0.12.2
